[![Run App Robinson, Alexander](https://github.com/ajrbones/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/ajrbones/GithubActions/actions/workflows/ci.yml)
